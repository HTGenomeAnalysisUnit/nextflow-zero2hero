...
1. [Exercise 1: Exploring nf-core Pipelines](#exercise-1-exploring-nf-core-pipelines)
2. [Exercise 2: Pulling and Launching nf-core Pipelines](#exercise-2-pulling-and-launching-nf-core-pipelines)
3. [Exercise 3: Pipeline Configuration with nf-core configs](#exercise-3-pipeline-configuration-with-nf-core-configs)
4. [Exercise 4: Preparing Input and Configuring Parameters](#exercise-4-preparing-input-and-configuring-parameters)
5. [Exercise 5: Understanding Pipeline Output Structure](#exercise-5-understanding-pipeline-output-structure)
6. [Exercise 6: Advanced Customization with Configuration Files](#exercise-6-advanced-customization-with-configuration-files)
