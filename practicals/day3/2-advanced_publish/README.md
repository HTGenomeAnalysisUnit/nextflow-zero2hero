...
Below are the key points to keep in mind when using `publishDir`. For more detailed information, you can refer to the official documentation for this directive at the following [link](https://www.nextflow.io/docs/latest/reference/process.html#publishdir).
